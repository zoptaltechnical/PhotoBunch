...
- (instancetype)initWithFrame:(CGRect)frame imageManager:(id<KSImageManager>)imageManager {
    ...
    if (self) {
        ...
        _playImage = [[UIImageView alloc] initWithFrame:CGRectMake(KAppdelegate.window.frame.size.width-25, KAppdelegate.window.frame.size.height-25,50, 50)];
       ...
       // _playImage.center = _imageView.center;
        ...
        [self addSubview:_imageView];
       // [_imageView addSubview:_playImage];
        [self bringSubviewToFront:_playImage];
